...
qemu-amd64)
    ...
    KERNEL_FILE=$IMAGE_DIR/margo-device-image-cip-core-trixie-qemu-amd64-vmlinuz
    INITRD_FILE=$IMAGE_DIR/margo-device-image-cip-core-trixie-qemu-amd64-initrd.img
    IMAGE_FILE=$IMAGE_DIR/margo-device-image-cip-core-trixie-qemu-amd64.ext4
...
qemu-arm64)
    ...
    KERNEL_FILE=$IMAGE_DIR/margo-device-image-cip-core-trixie-qemu-arm64-vmlinux
    INITRD_FILE=$IMAGE_DIR/margo-device-image-cip-core-trixie-qemu-arm64-initrd.img
    IMAGE_FILE=$IMAGE_DIR/margo-device-image-cip-core-trixie-qemu-arm64.ext4
